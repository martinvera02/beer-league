...
export default function Ranking({ selectedLeague, setSelectedLeague }) {
  ...
  useEffect(() => {
    if (selectedLeague) fetchRanking(selectedLeague.id)
  }, [selectedLeague])
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white pb-24 px-4 pt-6">
      <div className="max-w-md mx-auto">
        ...
        {/* ID para compartir */}
        {selectedLeague && (
          <div className="bg-gray-900 rounded-2xl px-4 py-3 mb-6 flex items-center justify-between">
            <div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className={`font-bold ${isMe ? 'text-white' : 'text-white'}`}>
